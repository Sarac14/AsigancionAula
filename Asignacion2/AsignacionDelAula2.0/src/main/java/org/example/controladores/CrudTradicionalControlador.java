...
public class CrudTradicionalControlador extends BaseControlador {
    ...
    EstudianteServices fakeServices = new EstudianteServices();
        ...
        app.routes(() -> {
            path("/crud-simple/", () -> {
                ...
                get("/listar", ctx -> {
                    ...
                    List<Estudiante> lista = fakeServices.listaEstudiantes();
                    //
                ...
                get("/visualizar/{matricula}", ctx -> {
                    Estudiante estudiante = fakeServices.getEstudiante(ctx.pathParamAsClass("matricula", Integer.class).get());
                    //
                    Map<String, Object> modelo = new HashMap<>();
